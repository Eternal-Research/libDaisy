...
{
    // Sysex disabled to save space
    static constexpr size_t kMaxDataSize = 3; // SYSEX_BUFFER_LEN + 2;
    ...
    static MidiTxMessage ControlChange(uint8_t ch, uint8_t cc, uint8_t val);
